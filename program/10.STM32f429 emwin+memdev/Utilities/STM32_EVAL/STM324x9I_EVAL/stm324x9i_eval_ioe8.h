...
#define IOE_I2C_SCL_PIN            GPIO_Pin_4
#define IOE_I2C_SCL_GPIO_PORT      GPIOH
#define IOE_I2C_SCL_GPIO_CLK       RCC_AHB1Periph_GPIOH
#define IOE_I2C_SCL_SOURCE         GPIO_PinSource4
#define IOE_I2C_SCL_AF             GPIO_AF_I2C2
#define IOE_I2C_SDA_PIN            GPIO_Pin_5
#define IOE_I2C_SDA_GPIO_PORT      GPIOH
#define IOE_I2C_SDA_GPIO_CLK       RCC_AHB1Periph_GPIOH
#define IOE_I2C_SDA_SOURCE         GPIO_PinSource5
#define IOE_I2C_SDA_AF             GPIO_AF_I2C2
...
/** 
  ...
  */ 
#define IOE_ADDR                   0x41			/* Touchscreen 7-bit I2C address 0x82*/
