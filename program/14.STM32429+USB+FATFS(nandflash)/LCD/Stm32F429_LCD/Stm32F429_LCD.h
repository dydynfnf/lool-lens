...
/** 
  ...
  */ 
#define LCD_I2C                          I2C2
#define LCD_I2C_CLK                      RCC_APB1Periph_I2C2
#define LCD_I2C_SCL_PIN                  GPIO_Pin_4
#define LCD_I2C_SCL_GPIO_PORT            GPIOH
#define LCD_I2C_SCL_GPIO_CLK             RCC_AHB1Periph_GPIOH
#define LCD_I2C_SCL_SOURCE               GPIO_PinSource4
#define LCD_I2C_SCL_AF                   GPIO_AF_I2C2
#define LCD_I2C_SDA_PIN                  GPIO_Pin_5
#define LCD_I2C_SDA_GPIO_PORT            GPIOH
#define LCD_I2C_SDA_GPIO_CLK             RCC_AHB1Periph_GPIOH
#define LCD_I2C_SDA_SOURCE               GPIO_PinSource5
#define LCD_I2C_SDA_AF                   GPIO_AF_I2C2
