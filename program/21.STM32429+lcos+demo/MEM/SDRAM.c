...
//sdram allocation
u32 FrameBuffer0[224*3][900]       __attribute__(( at(0xD0000000) ));
u32 FrameBuffer1[224*3][900]       __attribute__(( at(0xD0000000+224*3*900*4) ));
u16 BlendedBuffer[224][900]			 	 __attribute__(( at(0xD0000000+224*3*900*4*2) ));
u32 EmwimBuffer[2*1024*1024]     	 __attribute__(( at(0xD0000000+224*3*900*4*2+224*900*2) ));
u32 MEM[224][900]									 __attribute__(( at(0xD0000000+224*3*900*4*2+224*900*2+2*1024*1024*4) ));
