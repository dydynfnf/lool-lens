...
static void _SetPixelIndex(GUI_DEVICE * pDevice, int x, int y, int PixelIndex) {
    ...
    u32 a,r,g,b;
    {
      ...
      //
			...
			FrameBuffer2[y][3*x] = a | r;
			FrameBuffer2[y][3*x+1] = a | g;
			FrameBuffer2[y][3*x+2] = a | b;
    }
...
static unsigned int _GetPixelIndex(GUI_DEVICE * pDevice, int x, int y) {
  unsigned int PixelIndex;
    ...
    u32 a,r,g,b;
    {
      ...
      // TBD by customer...
      //
			a=FrameBuffer2[y][3*x] & 0xff000000;
			r=FrameBuffer2[y][3*x] & 0x000000ff;
			g=FrameBuffer2[y][3*x+1] & 0x000000ff;
			b=FrameBuffer2[y][3*x+2] & 0x000000ff;
...
static void _SetOrg(GUI_DEVICE * pDevice, int x, int y) {
  ...
  LCD_X_DisplayDriver(pDevice->LayerIndex, LCD_X_SETORG, (void *)&Data);
	...
	DMA2D->FGMAR = (uint32_t)FrameBuffer2+(x+900*y)*4;
}
...
*/
const GUI_DEVICE_API GUIDRV_Layer2_API = {
  //
  // Data
  //
  DEVICE_CLASS_DRIVER,
