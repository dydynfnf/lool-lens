...
extern u32 FrameBuffer1[448][900];//allocation in SDRAM.c
extern u32 FrameBuffer2[448][900];//allocation in SDRAM.c
...
{ 
  ...
  LTDC_Layer_InitTypeDef LTDC_Layer_InitStruct;
	...
	*/ 
	...
	/* Configure Layer2 */
//	LTDC_Layer_InitStruct.LTDC_CFBStartAdress = (uint32_t)&FrameBuffer2;
...
void DMA2D_Config(void)
{
  ...
  DMA2D_FG_InitStruct.DMA2D_FGMA = (uint32_t)FrameBuffer2;
...
//  DMA2D_FG_InitStruct.DMA2D_FGPFC_ALPHA_VALUE = 0;
  ...
  DMA2D_BG_InitStruct.DMA2D_BGMA = (uint32_t)FrameBuffer1;
