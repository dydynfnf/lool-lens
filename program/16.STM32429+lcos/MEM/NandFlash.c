...
void NAND_Init(void)
{
  ...
  RCC_AHB3PeriphClockCmd(RCC_AHB3Periph_FSMC, ENABLE); 
	//GPIOD引脚初始化
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource0,  GPIO_AF_FSMC);   //数据位2
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource1,  GPIO_AF_FSMC);   //数据位3
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource4,  GPIO_AF_FSMC);   //NOE位
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource5,  GPIO_AF_FSMC);   //NWE位
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource6,  GPIO_AF_FSMC);   //NWAIT位
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource11, GPIO_AF_FSMC);   //地址位16
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource12, GPIO_AF_FSMC);   //地址位17
	GPIO_PinAFConfig(GPIOD, GPIO_PinSource14, GPIO_AF_FSMC);   //数据位0
  GPIO_PinAFConfig(GPIOD, GPIO_PinSource15, GPIO_AF_FSMC);   //数据位1
  ...
  GPIO_Init(GPIOD, &GPIO_InitStructure);
	//GPIOE引脚初始化
	GPIO_PinAFConfig(GPIOE, GPIO_PinSource7,  GPIO_AF_FSMC);   //数据位4
  GPIO_PinAFConfig(GPIOE, GPIO_PinSource8,  GPIO_AF_FSMC);   //数据位5
	GPIO_PinAFConfig(GPIOE, GPIO_PinSource9,  GPIO_AF_FSMC);   //数据位6
  GPIO_PinAFConfig(GPIOE, GPIO_PinSource10, GPIO_AF_FSMC);   //数据位7
